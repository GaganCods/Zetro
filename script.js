...
// Show policy section when clicking on footer links
...
// Close policy section when clicking on close icon
closeIcons.forEach(icon => {
    icon.addEventListener('click', () => {
        const policySection = icon.closest('.policy-section');
        if (policySection) {
...
// Close policy section when clicking outside the content
policySections.forEach(section => {
    section.addEventListener('click', (e) => {
        // Check if the click is outside the policy-content
        if (e.target === section) {
